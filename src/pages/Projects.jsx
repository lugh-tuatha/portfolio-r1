  ...
  return (  
    <>
      ...
      <div className='mt-10 w-11/12 xl:w-9/12 mx-auto'>
        ...
        <p className='mt-6'>List of my projects</p>

        <h1 className="text-3xl mt-16 "><span className='text-primary'>#</span>complete-websites</h1>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {project.map(projects => (
            <ProjectComponents key={projects.id} languages={projects.languages} title={projects.title} desc={projects.desc} live={projects.live} repo={projects.repo} cover={projects.cover}/>
          ))}
        </div>
